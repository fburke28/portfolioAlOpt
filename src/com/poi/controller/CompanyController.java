...
import com.poi.service.ICompanyService;
import com.poi.view.CompanyView;
...
public class CompanyController {
	...
	@ResponseBody
	public SectorsView retrieveSectors() {
		SectorsView view = new SectorsView();
		List<String> sectors = companyService.retrieveCompanySectors();
		view.setSectors(sectors);
	 ...
	 * @return List of sectors
	 */
	@RequestMapping(value = "/retrieveSectorsByJson", method = RequestMethod.GET)
	 ...
	 * @return List of sectors
	 */
	@RequestMapping(value = "/retrieveCompanyDetailsByJson", method = RequestMethod.GET)
