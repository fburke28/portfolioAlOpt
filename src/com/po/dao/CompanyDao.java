...
/**
 * Interface used to define methods for Company data access layer.
 * 
 * <p>
...
public interface CompanyDao {
	 ...
	 */
	void insertCompany(Map<String, List<Company>> sector2Company);

	/**
	 * Method used to update a company
	 * @param Company The company to update
	 */
	void updateCompany(List<Company> company);
