<script type="text/javascript">
	swfobject.registerObject("userDetailsPortlet", "9.0.0", "expressInstall.swf");
</script>

<div id="flashcontent" style="width: 98%; margin-left: auto; margin-right: auto; height: 100%">
	<object id="userDetailsPortlet" data="<%= request.getContextPath() %>/swfs/userDetails.swf" type="application/x-shockwave-flash" width="100%" height="100%">
        ...
        <param name="movie" value="<%= request.getContextPath() %>/swfs/userDetails.swf" />
        <param name="FlashVars" value="userName=<%= request.getUserPrincipal().getName() %>&accountNumber=${accountNumber}" />

        <!--[if !IE]>-->
        <object type="application/x-shockwave-flash" data="<%= request.getContextPath() %>/swfs/userDetails.swf" width="100%" height="100%"
